    ...
    return <header className={`navbar ${isOpen ? 'open' : ''} ${isBackground || always ? 'background' : ''}`}>
        <Navbar color="light" light expand="md" className="clearfix">
            <Link to="/" className="logo logo-mysak">
                <StaticImage placeholder="none" loading="eager" style={{ maxHeight: '100%' }} imgStyle={{ maxHeight: '100%' }} height={90} formats={["auto", "webp"]} src='../../assets/logo_mysak_cropped_scaled.png' layout='constrained' alt="Logo ski mysak" />
            </Link>
            <a href="https://www.skikarlov.cz/" className="logo logo-karlov" target="_blank">
                <StaticImage placeholder="none" loading="eager" style={{ maxHeight: '100%' }} imgStyle={{ maxHeight: '100%' }} height={90} formats={["auto", "webp"]} src='../../assets/logo-arena.png' layout='constrained' alt="Logo ski arena karlov" />
            </a>
